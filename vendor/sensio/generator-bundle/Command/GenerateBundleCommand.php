...
<info>php %command.full_name% --namespace=Acme/HikingBundle</info>
...
<info>php %command.full_name% --namespace=Acme/HikingBundle --dir=src [--bundle-name=...] --no-interaction</info>
...
EOT
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($shared) {
            ...
            $output->writeln(array(
                'Each bundle is hosted under a namespace (like <comment>Acme/HikingBundle</comment>).',
            ...
            $output->writeln(array(
                'Give your bundle a descriptive name, like <comment>HikingBundle</comment>.',
            ));
