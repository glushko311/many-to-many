 ...
 */
class Member extends \TrackBundle\Entity\Member implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'TrackBundle\\Entity\\Member' . "\0" . 'id', '' . "\0" . 'TrackBundle\\Entity\\Member' . "\0" . 'name', '' . "\0" . 'TrackBundle\\Entity\\Member' . "\0" . 'tracks'];
        }
